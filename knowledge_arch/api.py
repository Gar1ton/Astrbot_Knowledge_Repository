...
from knowledge_arch.api_capabilities import CapabilitiesApiMixin
...
from knowledge_arch.ingest_job import (
    INGEST_ERROR,
    INGEST_STAGE_INDEXING,
    INGEST_SUCCESS,
    IngestJob,
)
from knowledge_arch.milvus_build import (
    MILVUS_BUILD_ERROR,
...
from knowledge_arch.pipelines.retrieval_orchestrator import ChunkSignal, RetrievalScope
...
from knowledge_arch.utils.text_chunks import clip_at_sentence
...
def _serialize_deep_thinking(outcome: Any) -> dict:
    ...
    """
    from knowledge_arch.pipelines.deep_thinking_view import serialize_outcome
...
if TYPE_CHECKING:
    ...
    from knowledge_arch.domain.models import DocumentChunk, QuotaUsage
    from knowledge_arch.index_compatibility import IndexCompatibilityStore
    from knowledge_arch.lightrag_core import BuildJob, LightRAGCoreRegistry
    from knowledge_arch.managers.base import (
        BaseCategoryManager,
        BaseIngestManager,
        BaseQuotaManager,
    )
    ...
    from knowledge_arch.repository.reranker.base import Reranker
...
class KnowledgeRepositoryApi(CapabilitiesApiMixin):
    ...
    async def _push_note_outbox(
        ...
        from knowledge_arch.domain.models import NotionOutboxItem
    ...
    async def estimate_graph_build(self, collection: str | None = None) -> dict:
        ...
        from knowledge_arch.lightrag_core import estimate_lightrag_build
    ...
    async def save_zotero_server_key(self, api_key: str) -> dict[str, Any]:
        ...
        from knowledge_arch.adapters.zotero.web_api import (
            ZoteroWebApiClient,
    ...
    async def _preflight_zotero_snapshot(
        ...
        from knowledge_arch.adapters.zotero.web_api import ZoteroWebApiClient, ZoteroWebApiReader
    ...
    async def sync_zotero_pull(
        ...
        if not _skip_account_guard and self._config is not None:
            from knowledge_arch.config import ZOTERO_ACCESS_SERVER
