...
用现有的内存实现（kacore/repository/*/memory.py）并播种示例数据装配 KnowledgeRepositoryApi，
...
from kacore.api import KnowledgeRepositoryApi  # noqa: E402
from kacore.ask_progress import ProgressStore  # noqa: E402
from kacore.config import Config  # noqa: E402
from kacore.domain.models import (  # noqa: E402
    Collection,
    DocumentChunk,
    SourceDocument,
    SyncTargetKind,
)
from kacore.metrics import PerformanceTracker  # noqa: E402
from kacore.repository.kb_reader.memory import InMemoryKnowledgeBaseReader  # noqa: E402
from kacore.repository.source_store.memory import InMemorySourceDocumentStore  # noqa: E402
from kacore.repository.sync_targets.memory import InMemorySyncTarget  # noqa: E402
