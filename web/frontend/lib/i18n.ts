...
const zh = {
  ...
  graph_config_rebuild_warn: "修改 Embedding 提供商、模型或接口后，Milvus 与各 collection 的 LightRAG 索引均需手动重建。",
  ...
  graph_config_working_dir_help: "LightRAG 为每个 collection 创建独立 workspace 的根目录；相对路径位于插件 data_dir 下。此处只读，需修改配置文件并重启方可变更。",
