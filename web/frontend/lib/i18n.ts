...
const zh = {
  ...
  graph_config_max_token_size: "最大 Token 数",
  graph_config_llm_max_async: "LLM 并发上限",
  graph_config_embedding_max_async: "Embedding 并发上限",
  graph_config_working_dir: "工作目录（只读）",
  graph_config_rebuild_warn: "修改向量维度或 Embedding 模型后，各 collection 的 LightRAG 索引需手动重建；重建前仍会显示成本估算并要求确认。",
...
const en: Record<keyof typeof zh, string> = {
  ...
  graph_config_max_token_size: "Max Token Size",
  ...
  graph_config_rebuild_warn: "Changing embedding dim or model requires manually rebuilding LightRAG indexes per collection. A cost estimate will appear before each rebuild.",
